...
document.querySelector('.Description .modal-title').innerHTML = '<i class="far fa-comment-alt"></i>&nbsp;Tin nhắn tình yêu';
document.querySelector('.Description .modal-body').innerHTML = 'Anh yêu bngoc <i class="fas fa-heart"></i> ';
var author = document.querySelector('.author .me');author.style.opacity = "0.5";

author.innerHTML = "Mọi thắc mắc bạn có thể liên hệ<a href='https://www.facebook.com/vhung.24/'>Viet Hung<a>";
